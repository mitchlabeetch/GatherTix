...
const envSchema = z.object({
  ...
  // Provider selection
  PAYMENT_PROVIDER: z.enum(["stripe", "paypal", "mollie", "zeffy", "manual"]).default("manual"),
  EMAIL_PROVIDER: z.enum(["smtp", "resend", "postal", "ses", "console"]).default("console"),
  STORAGE_PROVIDER: z.enum(["minio", "s3", "local"]).default("local"),

  // Zeffy
  ZEFFY_FORM_BASE_URL: z.string().optional(),
  ZEFFY_WEBHOOK_SECRET: z.string().optional(),
