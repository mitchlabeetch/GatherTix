...
export type ApiKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "organizationId" | "name" | "keyHash" | "keyPrefix" | "permissions" | "lastUsedAt" | "usageCount" | "expiresAt" | "isRevoked" | "revokedAt" | "revokedReason" | "createdAt", ExtArgs["result"]["apiKey"]>;
