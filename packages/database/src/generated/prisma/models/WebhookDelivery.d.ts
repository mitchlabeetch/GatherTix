...
type GetWebhookDeliveryGroupByPayload<T extends WebhookDeliveryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<WebhookDeliveryGroupByOutputType, T['by']> & {
...
export type WebhookDeliveryWhereInput = {
    ...
    completedAt?: Prisma.DateTimeNullableFilter<"WebhookDelivery"> | Date | string | null;
...
export type WebhookDeliveryScalarWhereWithAggregatesInput = {
    ...
    completedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"WebhookDelivery"> | Date | string | null;
};
...
export type WebhookDeliveryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "webhookId" | "event" | "payload" | "requestHeaders" | "responseBody" | "responseStatus" | "status" | "attempt" | "maxAttempts" | "nextRetryAt" | "createdAt" | "completedAt", ExtArgs["result"]["webhookDelivery"]>;
...
export interface WebhookDeliveryFieldRefs {
    ...
    readonly completedAt: Prisma.FieldRef<"WebhookDelivery", 'DateTime'>;
}
/**
